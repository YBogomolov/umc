...
export const DEFAULT_STYLE_PROMPT = `highly detailed vector illustration with clean edges suitable for cutting out.`;
...
export const BACK_VIEW_SYSTEM_PROMPT = `Draw the back side of this paper miniature figure. White background, no outlines. Keep the same visual style. Do not add extra details, bases, pedestals, etc. The image should have exactly the same silhuette. Perspective: this is a 180-degree rotation of a view around the figure depicted in the image.`;
